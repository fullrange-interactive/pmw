...
Drawing = Drawing.extend({
    showProperties:function(dom){
		...
		typeSelect.append($('<option value="trueRandom" ' + ((this.data.type=='trueRandom')?'selected':'') + '>Aléatoire</option>'));
        typeSelect.append($('<option value="random" ' + ((this.data.type=='random')?'selected':'') + '>Aléatoire ou nouveau</option>'));
