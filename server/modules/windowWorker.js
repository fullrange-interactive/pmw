                        ...
                        if ( groupSlide != null ){
                            Slide.findById(groupSlide.slide, function (err, slide){
                                ...
                                for(var j = 0; j < slide.relems.length; j++ ){
                                    ...
                                    // Why did I do this by hand before?
                                    console.log("sending slide debug:")
                                    if ( groupSlide.data && groupSlide.data.relems && groupSlide.data.relems[relem._id] ){
                                        for ( var key in groupSlide.data.relems[relem._id] ){
                                            console.log(key + " = " + groupSlide.data.relems[relem._id][key]);
                                        }
                                    }
