...
N("mouseup");N("mousemove");N("mouseover");N("mouseout");d.event.fix=function(c){var a,c=ha.call(d.event,c);if(c.pageX!==A&&c.offsetX===A&&(a=d(c.target).offset()))c.offsetX=c.pageX-a.left,c.offsetY=c.pageY-a.top;return c};d.fn.draw=function a(b){var e,g,b=b||{};"function"===typeof b&&(b={fn:b});for(e=0;e<this.length;e+=1)if((g=z(this[e]))&&b.fn)G(this[e],b,a),b.fn.call(this[e],g);return this};d.fn.clearCanvas=function(a){for(var b,e=x(new B,a),a=0;a<this.length;a+=1)if(b=z(this[a]))H(a,b,e,e.width,
e.height),b.setTransform(1,0,0,1,0,0),!e.x||!e.y||!e.width||!e.height?b.clearRect(0,0,this[a].width,this[a].height):b.clearRect(e.x-e.width/2,e.y-e.height/2,e.width,e.height),b.restore();return this};d.fn.saveCanvas=function(){var a,b,e;for(a=0;a<this.length;a+=1)if(b=z(this[a]))e=I(this[a]),b.save(),e.savedTransforms=x({},e.transforms);return this};d.fn.restoreCanvas=function(){var a,b,e;for(a=0;a<this.length;a+=1)if(b=z(this[a]))e=I(this[a]),b.restore(),e.transforms=e.savedTransforms;return this};
d.fn.translateCanvas=function(a){for(var b,e=x(new B,a),g,a=0;a<this.length;a+=1)if(b=z(this[a]))g=I(this[a]),e.autosave&&b.save(),Z(b,e,g.transforms);return this};d.fn.scaleCanvas=function(a){for(var b,e=x(new B,a),g,a=0;a<this.length;a+=1)if(b=z(this[a]))g=I(this[a]),e.autosave&&b.save(),$(b,e,g.transforms);return this};d.fn.rotateCanvas=function(a){for(var b,e=x(new B,a),g,a=0;a<this.length;a+=1)if(b=z(this[a]))g=I(this[a]),e.autosave&&b.save(),aa(b,e,g.transforms);return this};d.fn.drawRect=function b(e){var g,
f,n=x(new B,e),d,s,u,q,j;for(g=0;g<this.length;g+=1)if(f=z(this[g]))G(this[g],e,b),J(f,n),H(g,f,n,n.width,n.height),f.beginPath(),d=n.x-n.width/2,s=n.y-n.height/2,(j=n.cornerRadius)?(n.closed=v,u=n.x+n.width/2,q=n.y+n.height/2,0>u-d-2*j&&(j=(u-d)/2),0>q-s-2*j&&(j=(q-s)/2),f.moveTo(d+j,s),f.lineTo(u-j,s),f.arc(u-j,s+j,j,3*C/2,2*C,F),f.lineTo(u,q-j),f.arc(u-j,q-j,j,0,C/2,F),f.lineTo(d+j,q),f.arc(d+j,q-j,j,C/2,C,F),f.lineTo(d,s+j),f.arc(d+j,s+j,j,C,3*C/2,F)):f.rect(d,s,n.width,n.height),n._event&&K(this[g],
f,e),M(f,n);return this};d.fn.drawArc=function e(g){var f,d,p=x(new B,g),g=g||{};!p.inDegrees&&360===p.end&&(g.end=p.end=2*C);for(f=0;f<this.length;f+=1)if(d=z(this[f]))G(this[f],g,e),J(d,p),H(f,d,p,2*p.radius),d.beginPath(),d.arc(p.x,p.y,p.radius,p.start*p._toRad-C/2,p.end*p._toRad-C/2,p.ccw),p._event&&K(this[f],d,g),M(d,p);return this};d.fn.drawEllipse=function g(f){var d,p,s=x(new B,f),u=4*s.width/3,q=s.height;s.closed=v;for(d=0;d<this.length;d+=1)if(p=z(this[d]))G(this[d],f,g),J(p,s),H(d,p,s,
s.width,s.height),p.beginPath(),p.moveTo(s.x,s.y-q/2),p.bezierCurveTo(s.x-u/2,s.y-q/2,s.x-u/2,s.y+q/2,s.x,s.y+q/2),p.bezierCurveTo(s.x+u/2,s.y+q/2,s.x+u/2,s.y-q/2,s.x,s.y-q/2),s._event&&K(this[d],p,f),M(p,s);return this};d.fn.drawPolygon=function f(d){var p,s,u=x(new B,d),q=2*C/u.sides,j=C/u.sides,l=j+C/2,m=u.radius*Q(q/2),o,i,k;u.closed=v;for(p=0;p<this.length;p+=1)if(s=z(this[p])){G(this[p],d,f);J(s,u);H(p,s,u,2*u.radius);s.beginPath();for(k=0;k<u.sides;k+=1)o=u.x+P(u.radius*Q(l)),i=u.y+P(u.radius*
S(l)),s.lineTo(o,i),u.projection&&(o=u.x+P((m+m*u.projection)*Q(l+j)),i=u.y+P((m+m*u.projection)*S(l+j)),s.lineTo(o,i)),l+=q;u._event&&K(this[p],s,d);M(s,u)}return this};d.fn.drawLine=function n(d){var i,u,q=x(new B,d),j,l,m;for(i=0;i<this.length;i+=1)if(u=z(this[i])){G(this[i],d,n);J(u,q);U(q);H(i,u,q,0);j=1;for(u.beginPath();v;)if(l=q["x"+j],m=q["y"+j],l!==A&&m!==A)u.lineTo(l,m),j+=1;else break;q._event&&K(this[i],u,d);M(u,q)}return this};d.fn.drawQuad=function p(d){var i,q,j=x(new B,d),l,m,o,r,
k;for(i=0;i<this.length;i+=1)if(q=z(this[i])){G(this[i],d,p);J(q,j);U(j);H(i,q,j,0);l=2;q.beginPath();for(q.moveTo(j.x1,j.y1);v;)if(m=j["x"+l],o=j["y"+l],r=j["cx"+(l-1)],k=j["cy"+(l-1)],m!==A&&o!==A&&r!==A&&k!==A)q.quadraticCurveTo(r,k,m,o),l+=1;else break;j._event&&K(this[i],q,d);M(q,j)}return this};d.fn.drawBezier=function s(d){var q,j,i=x(new B,d),m,o,r,k,h,t,w,y;for(q=0;q<this.length;q+=1)if(j=z(this[q])){G(this[q],d,s);J(j,i);U(i);H(q,j,i,0);m=2;o=1;j.beginPath();for(j.moveTo(i.x1,i.y1);v;)if(r=
i["x"+m],k=i["y"+m],h=i["cx"+o],t=i["cy"+o],w=i["cx"+(o+1)],y=i["cy"+(o+1)],r!==A&&k!==A&&h!==A&&t!==A&&w!==A&&y!==A)j.bezierCurveTo(h,t,w,y,r,k),m+=1,o+=2;else break;i._event&&K(this[q],j,d);M(j,i)}return this};d.fn.drawText=function u(q){var j,l,m=x(new B,q),o,r,k,h;for(j=0;j<this.length;j+=1)if(d(this[j]),l=z(this[j])){G(this[j],q,u);J(l,m);l.textBaseline=m.baseline;l.textAlign=m.align;l.font=m.font;if(!j&&m.maxWidth!==i){o=l;r=m.text;h=m.maxWidth;var t=m.text.split(" "),w=[],y="";if(o.measureText(r).width<
h)w=[r];else for(;0<t.length;)o.measureText(t[0]).width>h||o.measureText(y+t[0]).width<h?y+=t.shift()+" ":(w.push(y),y=""),0===t.length&&w.push(y);o=w;o=o.join("\n").replace(/( (\n))|( $)/gi,"$2").split("\n")}else j||(o=(""+m.text).split("\n"));fa(this[j],j,l,m,o);H(j,l,m,m.width,m.height);j||(k=m.x,"left"===m.align?k-=m.width/2:"right"===m.align&&(k+=m.width/2));for(r=0;r<o.length;r+=1)l.shadowColor=m.shadowColor,h=m.y+r*m.height/o.length-(o.length-1)*m.height/o.length/2,l.fillText(o[r],k,h),"transparent"!==
m.fillStyle&&(l.shadowColor="transparent"),l.strokeText(o[r],m.x,h);m._event?(l.beginPath(),l.rect(m.x-m.width/2,m.y-m.height/2,m.width,m.height),l.restore(),K(this[j],l,q),l.closePath()):l.restore()}E=m;return this};d.fn.measureText=function(d){var i;i=d!==A&&"object"!==typeof d?this.getLayer(d):x(new B,d);(d=z(this[0]))&&i.text!==A&&fa(this[0],0,d,i,i.text.split("\n"));return i};d.fn.drawImage=function q(d){function l(q,k,l){return function(){k||((y=t.width/t.height,h.width===i&&h.sWidth===i&&(d.width=
...
2),0>h.sx-h.sWidth/2&&(h.sx=h.sWidth/2),0>h.sy-h.sHeight/2&&(h.sy=h.sHeight/2),h.sy+h.sHeight/2>t.height&&(h.sy=t.height-h.sHeight/2),h.width!==i&&h.height===i)?d.height=h.height=h.width/y:h.width===i&&h.height!==i?d.width=h.width=h.height*y:h.width===i&&h.height===i&&(d.width=h.width=t.width,d.height=h.height=t.height));H(k,l,h,h.width,h.height);l.drawImage(t,h.sx-h.sWidth/2,h.sy-h.sHeight/2,h.sWidth,h.sHeight,h.x-h.width/2,h.y-h.height/2,h.width,h.height);l.fillStyle=l.strokeStyle="transparent";
l.beginPath();l.rect(h.x-h.width/2,h.y-h.height/2,h.width,h.height);h._event&&K(m[k],l,d);M(l,h);h.load&&h.load.call(q,d)}}var m=this,o,r,k,h=x(new B,d),t,w,y;w=h.source.getContext;h.source.src||w?(t=h.source,h.width=t.width,h.height=t.height):h.source&&(t=new W,t.src=h.source);for(r=0;r<m.length;r+=1)if(o=m[r],k=z(m[r]))G(m[r],d,q),J(k,h),t&&(t.complete||w?l(o,r,k)():(t.onload=l(o,r,k),t.src=t.src));return m};d.fn.createPattern=d.fn.pattern=function(d){function j(){k=m.createPattern(r,o.repeat);
o.load&&o.load.call(l[0],k)}var l=this,m,o=x(new B,d),r,k;(m=z(l[0]))?"function"===typeof o.source?(r=T.createElement("canvas"),r.width=o.width,r.height=o.height,d=z(r),o.source.call(r,d),j()):(d=o.source.getContext,o.source.src||d?r=o.source:(r=new W,r.src=o.source),r.complete||d?j():r.onload=j):k=i;return k};d.fn.createGradient=d.fn.gradient=function(d){var j,d=x(new B,d),l=[],m,o,r,k,h,t,w;if(j=z(this[0])){d.x1=d.x1||0;d.y1=d.y1||0;d.x2=d.x2||0;d.y2=d.y2||0;j=d.r1!==i||d.r2!==i?j.createRadialGradient(d.x1,
d.y1,d.r1,d.x2,d.y2,d.r2):j.createLinearGradient(d.x1,d.y1,d.x2,d.y2);for(k=1;d["c"+k]!==A;k+=1)d["s"+k]!==A?l.push(d["s"+k]):l.push(i);m=l.length;l[0]===i&&(l[0]=0);l[m-1]===i&&(l[m-1]=1);for(k=0;k<m;k+=1){if(l[k]!==i){t=1;w=0;o=l[k];for(h=k+1;h<m;h+=1)if(l[h]!==i){r=l[h];break}else t+=1;o>r&&(l[h]=l[k])}else l[k]===i&&(w+=1,l[k]=o+w*((r-o)/t));j.addColorStop(l[k],d["c"+(k+1)])}}else j=i;return j};d.fn.setPixels=function j(d){var i,o,r,k=x(new B,d),h={},t,w,y,v;for(o=0;o<this.length;o+=1)if(i=this[o],
r=z(i)){G(this[o],d,j);H(o,r,k,k.width,k.height);if(!k.x||!k.y||!k.width||!k.height)k.width=i.width,k.height=i.height,k.x=k.width/2,k.y=k.height/2;t=r.getImageData(k.x-k.width/2,k.y-k.height/2,k.width,k.height);w=t.data;v=w.length;h=[];if(k.each)for(y=0;y<v;y+=4)h.r=w[y],h.g=w[y+1],h.b=w[y+2],h.a=w[y+3],k.each.call(i,h),w[y]=h.r,w[y+1]=h.g,w[y+2]=h.b,w[y+3]=h.a;r.putImageData(t,k.x-k.width/2,k.y-k.height/2);r.restore()}return this};d.fn.getCanvasImage=function(d,l){var m=this[0];return m&&m.toDataURL?
m.toDataURL("image/"+d,l):i};d.support.canvas=T.createElement("canvas").getContext!==A;D.defaults=O;D.checkEvents=K;d.jCanvas=D})(jQuery,document,Image,Math,parseFloat,!0,!1,null);